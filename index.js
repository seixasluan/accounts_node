...
function checkAccount(accountName) {
  if (!fs.existsSync(`accounts/${accountName}.json`)) {
    console.log(chalk.bgRed.black('Essa conta não existe, escolha uma conta existente!'));
    return false;
  } else {
    return true;
  }
...
function removeAmount(accountName, amount) {
  ...
  console.log(chalk.bgBlue.black(`Foi realizado um saque de R$${amount} da sua conta!`));
  operation();
}